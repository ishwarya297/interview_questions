...
class DataTransformationBasePlusOneOmsShipmentPreferenceAdjustment:
    def __init__(self):
    ...
    def transformation_query(self, dq_checked_dataframe):
        ...
        transformed_dataframe=dq_checked_dataframe.select(
                                                  *CurationCommonConstant.AUDIT_COLUMNS
                                                  ...
                                                  ,col('data.invoiceEventDetail.shipmentPreferenceAdjustment.fulfilledFromNodeId').alias('ship_preference_adjustment_fulfilled_from_node_id')  
                                                  ,col('data.invoiceEventDetail.shipmentPreferenceAdjustment.maximumDaysToDeliver').alias('ship_preference_adjustment_maximum_days_to_deliver') 
                                                  ,col('data.invoiceEventDetail.shipmentPreferenceAdjustment.minimumDaysToDeliver').alias('ship_preference_adjustment_minimum_days_to_deliver') 
                                                  ,col('data.invoiceEventDetail.shipmentPreferenceAdjustment.isBusinessDay').alias('ship_preference_adjustment_is_business_day') 
                                                  ,col('data.invoiceEventDetail.shipmentPreferenceAdjustment.withinCutoff').alias('ship_preference_adjustment_is_within_cutoff') 
                                                  ,col('data.invoiceEventDetail.shipmentPreferenceAdjustment.shipMethod').alias('ship_preference_adjustment_method') 
                                                  ,col('data.invoiceEventDetail.shipmentPreferenceAdjustment.shippingGroup').alias('ship_preference_adjustment_shipping_group') 
                                                  ,col('data.invoiceEventDetail.shipmentPreferenceAdjustment.shipChargeOverrideReason').alias('ship_preference_adjustment_ship_charge_override_reason') 
                                                  ,col('data.invoiceEventDetail.shipmentPreferenceAdjustment.instruction.header').alias('ship_preference_adjustment_instruction_header') 
                                                  ,col('data.invoiceEventDetail.shipmentPreferenceAdjustment.instruction.footer').alias('ship_preference_adjustment_instruction_footer') 
                                                  ,col('data.invoiceEventDetail.shipmentPreferenceAdjustment.instruction.body').alias('ship_preference_adjustment_instruction_body') 
                                                  ,col('data.invoiceEventDetail.shipmentPreferenceAdjustment.instruction.type').alias('ship_preference_adjustment_instruction_type') 
                                                  ,col('data.invoiceEventDetail.shipmentPreferenceAdjustment.convenienceCharges').cast(convenience_charge_schema).alias('ship_preference_adjustment_convenience_charge')
                                                  ,col('data.invoiceEventDetail.shipmentPreferenceAdjustment.convenienceTaxes').cast(convenience_charge_tax_schema).alias('ship_preference_adjustment_convenience_charge_tax')
